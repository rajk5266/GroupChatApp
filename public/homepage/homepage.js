...
const socket = io('https://chatprivate.onrender.com')
...
const sendMessage = async (event) => {
  ...
  if (selectedFile) {
    ...
    fileReader.onload = async function () {
      ...
      // console.log(payload)
      const response = await axios.post('https://chatprivate.onrender.com/sendMediaFile', payload, token);
    ...
    const messageSend = await axios.post('https://chatprivate.onrender.com/messages', messageObj, token)
    messageInput.value = '';
  }
};
